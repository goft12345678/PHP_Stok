...
$sql="SELECT * FROM `deta_stock` WHERE id = $form";//"SELECT * FROM week1 WHERE id = $edif" เรียกข้อมูล มาใส่
  ...
  <main class="container" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>ชื่อสินค้า</th>
                <td  colspan="5"><?php echo $row[2]; ?></td>
                
            </tr>
            <tr>
                <tH>คำอธิบาย</tH> 
                <td colspan="5"><?php echo $row[4]; ?></td>
                
            </tr>

            <tr> 
                <th>ราคา </th>
                <td colspan="5" ><?php echo $row[5]; ?></td>
            ...
            <tr>
                <th>สินค้าทั้งหมด</th>
                <td colspan="4" ><?php echo $row[6]; ?></td>
                <th>สินค้าทั้งหมด</th>
            </tr>
